...
export const CartServiceMock = {
  ...
  editProductQuantityInCart: jasmine.createSpy('editProductQuantityInCart').and.returnValue({ status: 'success' }),
  getCart: jasmine.createSpy('getCart').and.returnValue([ProductMock])
}
